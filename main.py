...
app.register_blueprint(web.user.bp)
...
def hello():
    return '''
    <div style="text-align: center; min-height: 90vh; display: flex; flex-direction: column; justify-content: center;">
        <h1>Arcana Server is running!</h1>
        <div style="margin-top: auto; padding: 10px 0;">
            <a href="http://beian.miit.gov.cn" style="color: #666; font-size: 14px;">
                闽ICP备2025107746号
            </a>
        </div>
    </div>
